...
<head>
  ...
  <title>Danh sách bệnh nhân - BV Mắt PTIT</title>
  ...
  <main class="main-content">
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div>
          <div class="topbar-title">Bệnh nhân hôm nay</div>
          <div style="font-size:12px;color:var(--text-muted)">Danh sách bệnh nhân</div>
        </div>
      </div>
    ...
    <div class="content-area">
      <div class="breadcrumb-h">
        ...
        <span class="current">Danh sách bệnh nhân</span>
      </div>

      <div class="card-hospital">
        <div class="card-header-h">
          <h5>Bệnh nhân hôm nay (${patients.size()})</h5>
          <div class="search-box">
            <span class="search-icon"><i class="fas fa-search"></i></span>
            <input class="form-control-h btn-sm" placeholder="Tìm tên hoặc mã bệnh nhân..." id="searchInput" oninput="filterPatients(this.value)">
          </div>
        </div>
