...
<head>
  ...
  <title>Hồ sơ bác sĩ - BV Mắt PTIT</title>
...
<div class="app-shell">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-item"><a href="${pageContext.request.contextPath}/doctor/profile" class="nav-link-h active"><span class="nav-icon"><i class="fas fa-user-doctor"></i></span><span class="nav-label">Hồ sơ bác sĩ</span></a></div>
    </nav>
  ...
  <main class="main-content">
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div><div class="topbar-title">Hồ sơ bác sĩ</div></div>
      </div>
    ...
    <div class="content-area">
      ...
      <div class="tab-nav-h">
        <button class="tab-btn active" onclick="switchTab(this,'tabInfo')"><i class="fas fa-id-badge" style="margin-right:6px"></i>Thông tin nghề nghiệp</button>
        <button class="tab-btn" onclick="switchTab(this,'tabPassword')"><i class="fas fa-lock" style="margin-right:6px"></i>Đổi mật khẩu</button>
      </div>
      ...
      <div class="tab-pane-h active" id="tabInfo">
        <div class="card-hospital" style="max-width:700px">
          ...
          <div class="card-body-h">
            <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px;padding-bottom:20px;border-bottom:1px solid var(--border)">
              ...
              <div>
                ...
                <div style="font-size:var(--font-sm);color:var(--text-muted)">${not empty doctor ? doctor.educationDegree : 'Bác sĩ'}</div>
              </div>
            </div>
            <form action="${pageContext.request.contextPath}/doctor/profile" method="post" id="profileForm">
              <div class="row g-3">
                <div class="col-md-6">
                  <label class="form-label-h">Chuyên khoa</label>
                ...
                <div class="col-md-6">
                  <label class="form-label-h">Học hàm / Học vị</label>
          ...
          <div class="card-footer-h" id="saveFooter" style="display:none">
            ...
            <button class="btn-hospital btn-primary-h btn-sm" onclick="document.getElementById('profileForm').submit()"><i class="fas fa-check"></i> Lưu thay đổi</button>
          </div>
        </div>
      </div>
          ...
          <div class="card-body-h">
            <form action="${pageContext.request.contextPath}/auth/change-password" method="post">
              <div class="form-group-h">
                ...
                <input class="form-control-h" type="password" name="currentPassword" id="oldPwd" placeholder="Nhập mật khẩu hiện tại">
              </div>
              <div class="form-group-h">
                <label class="form-label-h">Mật khẩu mới <span class="required">*</span></label>
                <input class="form-control-h" type="password" name="newPassword" id="newPwd" placeholder="Tối thiểu 8 ký tự">
              </div>
              <div class="form-group-h">
                <label class="form-label-h">Xác nhận mật khẩu mới <span class="required">*</span></label>
                <input class="form-control-h" type="password" name="confirmPassword" id="confirmPwd" placeholder="Nhập lại mật khẩu mới">
                <div id="matchHint" style="font-size:12px;margin-top:4px"></div>
              </div>
              <button type="submit" class="btn-hospital btn-primary-h"><i class="fas fa-shield-halved"></i> Cập nhật mật khẩu</button>
            </form>
          </div>
        </div>
      </div>
